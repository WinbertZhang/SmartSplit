...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-r from-customBlue via-customBlue to-green-800 animate-gradientMove">
      ...
      <div className="flex-grow flex flex-col lg:flex-row items-start justify-between max-w-screen-lg py-20 md:py-40 mx-auto relative z-10 px-4 md:px-0">
        
        {/* Left Column: Text and Buttons */}
        <div className="flex flex-col items-start justify-center text-left space-y-8 max-w-lg md:pr-8">
          {/* Title */}
          <h1 className="text-white text-3xl md:text-[2.5rem] leading-tight md:leading-none sm:text-6xl tracking-tight font-bold mt-8">
            Welcome to{" "}
      ...
      <div className="bg-green-400 py-12 px-6 md:py-16 md:px-8 rounded-lg border border-green-400 bg-opacity-10 my-10 md:my-20 max-w-screen-md mx-auto">
